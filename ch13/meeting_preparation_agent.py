...
async def main():
    ...
    check if there are meeting notes for any of the participants
    (name will be related to the email in the calendar, but it
    will likely not match completely), and provide a summary of the
    relevant information for the meeting. Format it as a short
    meeting brief. Do not suggest follow up. Write the meeting
    brief.
    '''
